...
//    @IBAction func getStockRatings(_ sender: Any) {
//
...
//
//            self.lblStockPrice.text = "\(quote.symbol) rating for \(quote.date) is \(quote.rating)"
//        }
//    }
//
    @IBAction func getStockRating(_ sender: Any) {
        ...
        AF.request(url).responseJSON { response in
            ...
            self.lblStockRating.text = "\(quote.symbol) rating for \(quote.date) is \(quote.rating)"
        }
    }
